...
function Footer() {
  ...
  return (
    <div className="container-footer text-center bg-black text-white">
        ...
        <div className="container px-6 pt-6">
            ...
            <a href="https://www.facebook.com/shelsyangelica.garcia,'_blank'" type="button" className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
            ...
            <a href="https://www.instagram.com/shelsyangelica/" type="button" className="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                <svg aria-hidden="true"
                focusable="false"
                data-prefix="fab"
                data-icon="instagram"
            ...
            <form onSubmit={handleForm}>
                ...
                <div className="md:ml-auto md:mb-6">
                    <p className="">
                    <strong>Suscríbete a nuestra pagina</strong>
                    </p>
                </div>
            ...
            <div className="grid lg:grid-cols-6 md:grid-cols-2">
                ...
                <div className="mb-6">
                    ...
                    <Link to="/trabaja-con-nosotros">
                        <ul className="list-none mb-0">
                        <li>
                            <a href="#!" className="text-white">Trabaja con nosostros</a>
                        </li>
                        </ul>
                    </Link>
                </div>
                ...
                <div onClick={handleClick} className="mb-6">
                    ...
                    <ul className="list-none mb-0">
                    <li>
                        <a href="" className="text-white">Contactanos</a>
                    </li>
